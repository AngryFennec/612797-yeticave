...
$my_bets = [];
$sql_bet = "SELECT b.lot_id, b.user_id, l.winner_id, u.contacts, l.name, l.category_id, l.end_date, l.img, b.sum, b.init_date FROM bets b JOIN lots l ON l.lot_id = b.lot_id JOIN users u ON b.user_id = u.user_id WHERE b.user_id = " . $user['user_id'];
