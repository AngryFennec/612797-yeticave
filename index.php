...
$sql_lot = "SELECT lot_id, name, c.cat_name, sum, img, end_date FROM lots l JOIN categories c ON l.category_id = c.category_id WHERE l.end_date > NOW() IS NULL ORDER BY l.init_date DESC LIMIT 6";
